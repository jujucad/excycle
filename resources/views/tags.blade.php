                                ...
                                <div>
                                  <div class="p-4">
                                    <div class="bg-white p-4 rounded-md">
                                      <div>
                                        <h2 class="mb-4 text-xl font-bold text-gray-700">Tags</h2>
                                        <div>
                                          <div>
                                            ...
                                            <div>
                                              <div class="flex justify-between border-t text-sm font-normal py-2 mt-4 space-x-4">
                                                <div class="px-2 flex">
                                                  <span>John Deo</span>
                                                </div>
                                                <div>
                                                ...
                                                <div class="px-2">
                                                    <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                                        ...
                                                        <span class="text-sm ml-2">arrow-down</span>
                                                        
                                                    </a>
                                                    <div class=" text-right">Modify</div>
